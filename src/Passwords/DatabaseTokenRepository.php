...
class DatabaseTokenRepository implements TokenRepositoryInterface
{
     ...
     */
    protected HashedInterface $hashed;
    ...
    public function __construct(
        ...
        $this->hashed = ($hasher = $options['hash_driver'] ?? null) instanceof HashedInterface
            ? $hasher
    ...
    public function exists(CanResetPasswordInterface $user, string $token): bool
    {
        ...
        return $record
               && ! $this->tokenExpired($record['created_at'])
                 && $this->hashed->check($token, $record['token']);
    }
    ...
    /**
     * Get the hashed instance.
     */
    public function getHashed(): HashedInterface
    {
        return $this->hashed;
    }
    ...
    {
        return ['email' => $email, 'token' => $this->hashed->make($token), 'created_at' => new Carbon()];
    }
